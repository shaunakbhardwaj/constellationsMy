...
export async function generateMindmapMarkdown(
    ...
    const model = config.model || process.env.NEXT_PUBLIC_DEFAULT_MODEL || 'openai/gpt-oss-20b';
...
// Get default model from env or use first available
export const DEFAULT_MODEL = import.meta.env.VITE_DEFAULT_MODEL || AVAILABLE_MODELS[0].id;
