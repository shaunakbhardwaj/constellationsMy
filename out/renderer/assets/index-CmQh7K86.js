...
function fallbackPlainTextToHeadings(markdown) {
  const lines = markdown.split("\n").map((line) => normalizeLineTitle(line)).filter(Boolean).filter((line) => !/^```/.test(line));
  if (lines.length === 0) return [];
  const root = lines[0];
  const remainder = lines.slice(1);
  const branchCandidates = remainder.length > 0 ? remainder : root.split(/[.!?]/).map((part) => normalizeLineTitle(part)).filter(Boolean).slice(1);
  const headings = [`# ${root}`];
...
function parseMarkdownToTree(markdown) {
  ...
  for (const line of lines) {
    ...
    if (level2 === 1) {
      ...
      while (stack.length > 0 && stack[stack.length - 1].level >= level2) {
        stack.pop();
      }
      if (stack.length > 0) {
...
const updateNodeInTree = (root, id, updater) => {
  if (root.id === id) {
    return updater(root);
  }
  return {
...
const deleteNodeFromTree = (root, id) => {
  return {
    ...root,
    children: root.children.filter((child) => child.id !== id).map((child) => deleteNodeFromTree(child, id))
  };
};
const setColorRecursive = (node, color) => ({
  ...node,
  branchColor: color,
  children: node.children.map((child) => setColorRecursive(child, color))
});
const isAncestor = (root, ancestorId, descendantId) => {
  const ancestor = findNode(root, ancestorId);
  if (!ancestor) return false;
  return findNode(ancestor, descendantId) !== null && ancestorId !== descendantId;
};
const getAncestorIds = (root, nodeId) => {
  const ancestors = [];
...
function useMindmapState(initialData) {
  ...
  const [selectedPathOrder, setSelectedPathOrder] = reactExports.useState([]);
  const [editingNodeId, setEditingNodeId] = reactExports.useState(null);
  const [expandingNodeId, setExpandingNodeId] = reactExports.useState(null);
  ...
  const addChild = reactExports.useCallback((parentId, title2 = "New Branch") => {
    if (!root) return null;
  ...
  const updateNode = reactExports.useCallback((nodeId, updates) => {
    setRoot((prevRoot) => {
      if (!prevRoot) return null;
  ...
  const setNodeColor = reactExports.useCallback((nodeId, color) => {
    setRoot((prevRoot) => {
      if (!prevRoot) return null;
      return updateNodeInTree(prevRoot, nodeId, (node) => setColorRecursive(node, color));
    });
  }, []);
  const resetNodeStyle = reactExports.useCallback((nodeId) => {
    if (!root) return;
  ...
  const setNodeNotes = reactExports.useCallback((nodeId, notes) => {
    setRoot((prevRoot) => {
      if (!prevRoot) return null;
      return updateNodeInTree(prevRoot, nodeId, (node) => ({
        ...node,
  ...
  const expandNode = reactExports.useCallback((nodeId, newChildren) => {
    setRoot((prevRoot) => {
      if (!prevRoot) return null;
  ...
  const getNode = reactExports.useCallback((nodeId) => {
    if (!root) return null;
    return findNode(root, nodeId);
  }, [root]);
  const getNodePath = reactExports.useCallback((nodeId) => {
    if (!root) return "";
    const path = [];
    const buildPath = (node, target) => {
      if (node.id === target) {
  ...
  const getDescendantCount = reactExports.useCallback((nodeId) => {
  ...
  const toggleCollapse = reactExports.useCallback((nodeId) => {
    setRoot((prevRoot) => {
      if (!prevRoot) return null;
      return updateNodeInTree(prevRoot, nodeId, (node) => ({
        ...node,
  ...
  const collapseSiblings = reactExports.useCallback((nodeId) => {
    if (!root) return;
    const parent = findParent(root, nodeId);
    if (!parent) return;
    setRoot((prevRoot) => {
  ...
  const isNodeInFocus = reactExports.useCallback((nodeId) => {
    if (!focusedNodeId || !root) return true;
  ...
  const getMainBranchId = reactExports.useCallback((nodeId) => {
    if (!root) return null;
  ...
  const togglePathSelection = reactExports.useCallback((nodeId) => {
  ...
  const clearPathSelection = reactExports.useCallback(() => {
    setSelectedNodeIds([]);
    setSelectedPathOrder([]);
  }, []);
  const movePathNode = reactExports.useCallback((nodeId, direction) => {
    setSelectedPathOrder((prev) => {
...
function CanvasOverlay({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$7.overlay, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: styles$7.header, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$7.headerRight, children: [
        saveStatus !== "idle" && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: `${styles$7.saveBadge} ${saveStatus === "saving" ? styles$7.saveBadgeSaving : saveStatus === "saved" ? styles$7.saveBadgeSaved : styles$7.saveBadgeError}`,
            "aria-live": "polite",
            children: saveStatus === "saving" ? "Saving…" : saveStatus === "saved" ? "Saved" : "Save failed"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$7.hint, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("kbd", { children: "Esc" }),
          " Close",
          onExport && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$7.separator, children: "•" }),
...
const menu = "_menu_13nda_1";
const colorRow = "_colorRow_13nda_30";
const colorButton = "_colorButton_13nda_37";
const divider = "_divider_13nda_57";
const menuItem = "_menuItem_13nda_64";
const menuIcon = "_menuIcon_13nda_88";
const menuLabel = "_menuLabel_13nda_102";
const badge = "_badge_13nda_106";
const deleteItem = "_deleteItem_13nda_119";
const disabled = "_disabled_13nda_136";
const shortcut = "_shortcut_13nda_150";
const styles$6 = {
  menu,
  colorRow,
  colorButton,
...
function NodeContextMenu({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$6.colorRow, children: MENU_COLORS.map((color) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            className: styles$6.colorButton,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            className: `${styles$6.menuItem} ${styles$6.deleteItem} ${isRoot ? styles$6.disabled : ""}`,
            onClick: isRoot ? void 0 : onDeleteNode,
            disabled: isRoot,
...
const backdrop$1 = "_backdrop_1d06m_1";
const modal = "_modal_1d06m_23";
const header$2 = "_header_1d06m_46";
const title$2 = "_title_1d06m_54";
const closeButton$2 = "_closeButton_1d06m_64";
const content$1 = "_content_1d06m_83";
const textarea = "_textarea_1d06m_87";
const charCount = "_charCount_1d06m_112";
const footer$1 = "_footer_1d06m_119";
const hint = "_hint_1d06m_126";
const actions$1 = "_actions_1d06m_145";
const cancelButton$1 = "_cancelButton_1d06m_150";
const saveButton = "_saveButton_1d06m_151";
const styles$5 = {
  backdrop: backdrop$1,
  modal,
  header: header$2,
...
function NotesModal({ node, onSave, onClose }) {
  const [notes, setNotes] = reactExports.useState(node.notes || "");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$5.backdrop, onClick: handleBackdropClick, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$5.modal, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$5.header, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: styles$5.title, children: [
        'Notes for "',
        node.title,
        '"'
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: styles$5.closeButton, onClick: onClose, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { width: "18", height: "18", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("line", { x1: "18", y1: "6", x2: "6", y2: "18" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("line", { x1: "6", y1: "6", x2: "18", y2: "18" })
      ] }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$5.content, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "textarea",
        {
          ref: textareaRef,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$5.charCount, children: [
        notes.length,
        " / 2000"
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$5.footer, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: styles$5.hint, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$5.actions, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: styles$5.cancelButton, onClick: onClose, children: "Cancel" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: styles$5.saveButton, onClick: handleSave, children: "Save Notes" })
      ] })
    ] })
  ] }) });
}
const backdrop = "_backdrop_looag_1";
const dialog = "_dialog_looag_23";
const icon = "_icon_looag_48";
const title$1 = "_title_looag_60";
const message$1 = "_message_looag_67";
const warning = "_warning_looag_79";
const actions = "_actions_looag_85";
const cancelButton = "_cancelButton_looag_90";
const deleteButton = "_deleteButton_looag_91";
const styles$4 = {
  backdrop,
  dialog,
  icon,
...
function DeleteConfirmDialog({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$4.backdrop, onClick: handleBackdropClick, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$4.dialog, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$4.icon, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { width: "32", height: "32", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "12", cy: "12", r: "10" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("line", { x1: "12", y1: "8", x2: "12", y2: "12" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("line", { x1: "12", y1: "16", x2: "12.01", y2: "16" })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: styles$4.title, children: "Delete Node?" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: styles$4.message, children: [
      ...
      descendantCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        " ",
        "and ",
        /* @__PURE__ */ jsxRuntimeExports.jsxs("strong", { children: [
          descendantCount,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: styles$4.warning, children: "This action cannot be undone." }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$4.actions, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: styles$4.cancelButton, onClick: onCancel, children: "Cancel" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: styles$4.deleteButton, onClick: onConfirm, children: [
        "Delete",
        descendantCount > 0 ? " All" : ""
      ] })
    ] })
  ] }) });
}
...
function ThemeProvider({ children }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeContext.Provider, { value: { theme, resolvedTheme, setTheme }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { visibility: mounted ? "visible" : "hidden" }, children }) });
}
function useTheme() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$3.overlay, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: panelRef, className: styles$3.panel, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$3.content, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$3.field, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "settingsTheme", children: "Appearance" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "select",
          {
            id: "settingsTheme",
...
const panel = "_panel_21roe_12";
const header = "_header_21roe_25";
const title = "_title_21roe_32";
const subtitle = "_subtitle_21roe_37";
const headerActions = "_headerActions_21roe_42";
const refreshButton = "_refreshButton_21roe_47";
const closeButton = "_closeButton_21roe_48";
const pathBox = "_pathBox_21roe_62";
const pathLabel = "_pathLabel_21roe_72";
const pathValue = "_pathValue_21roe_79";
const list = "_list_21roe_85";
const sectionLabel = "_sectionLabel_21roe_92";
const entry = "_entry_21roe_100";
const entryHeader = "_entryHeader_21roe_107";
const level = "_level_21roe_115";
const level_info = "_level_info_21roe_124";
const level_warn = "_level_warn_21roe_129";
const level_error = "_level_error_21roe_134";
const scope = "_scope_21roe_139";
const ts = "_ts_21roe_144";
const message = "_message_21roe_149";
const meta = "_meta_21roe_154";
const emptyState = "_emptyState_21roe_164";
const styles$2 = {
  overlay,
  panel,
  header,
...
function DiagnosticsPanel({
  ...
  if (!isOpen) return null;
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$2.overlay, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: panelRef, className: styles$2.panel, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$2.header, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: styles$2.title, children: "Diagnostics" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: styles$2.subtitle, children: "Recent runtime logs from the local app logger." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$2.headerActions, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: styles$2.refreshButton, onClick: onRefresh, disabled: isLoading, children: isLoading ? "Refreshing…" : "Refresh" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: styles$2.closeButton, onClick: onClose, "aria-label": "Close diagnostics", children: "×" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$2.pathBox, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$2.pathLabel, children: "Log file" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("code", { className: styles$2.pathValue, children: logPath || "No log file yet" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$2.pathBox, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$2.pathLabel, children: "LLM log file" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("code", { className: styles$2.pathValue, children: llmLogPath || "No LLM log file yet" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$2.list, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$2.sectionLabel, children: "LLM Exchanges" }),
      llmEntries.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$2.emptyState, children: "No LLM exchanges recorded yet." }) : llmEntries.map((entry2, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$2.entry, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$2.entryHeader, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `${styles$2.level} ${styles$2[`level_${entry2.status === "success" ? "info" : "error"}`]}`, children: entry2.status }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$2.scope, children: entry2.operation }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$2.scope, children: entry2.model }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$2.ts, children: new Date(entry2.ts).toLocaleString() })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$2.message, children: [
          "Request ID: ",
          entry2.requestId
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("pre", { className: styles$2.meta, children: JSON.stringify({
          systemPrompt: entry2.systemPrompt,
          userPrompt: entry2.userPrompt,
          response: entry2.content,
          error: entry2.error,
          temperature: entry2.temperature,
          maxTokens: entry2.maxTokens,
          responseFormat: entry2.responseFormat
        }, null, 2) })
      ] }, `${entry2.requestId}-${index}`)),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$2.sectionLabel, children: "Runtime Logs" }),
      entries.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$2.emptyState, children: "No log entries yet." }) : entries.map((entry2, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$2.entry, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$2.entryHeader, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `${styles$2.level} ${styles$2[`level_${entry2.level}`]}`, children: entry2.level }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$2.scope, children: entry2.scope }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$2.ts, children: new Date(entry2.ts).toLocaleString() })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$2.message, children: entry2.message }),
        entry2.meta && /* @__PURE__ */ jsxRuntimeExports.jsx("pre", { className: styles$2.meta, children: JSON.stringify(entry2.meta, null, 2) })
      ] }, `${entry2.ts}-${index}`))
    ] })
  ] }) });
}
const bar = "_bar_hvnym_1";
const expanding = "_expanding_hvnym_31";
const nodeTag = "_nodeTag_hvnym_35";
const nodeTitle = "_nodeTitle_hvnym_45";
const modesRow = "_modesRow_hvnym_54";
const modeButton = "_modeButton_hvnym_60";
const modeLabel = "_modeLabel_hvnym_92";
const modeButtonActive = "_modeButtonActive_hvnym_102";
const inputRow = "_inputRow_hvnym_143";
const customInput = "_customInput_hvnym_162";
const expandButton = "_expandButton_hvnym_190";
const loadingOverlay = "_loadingOverlay_hvnym_212";
const spinner = "_spinner_hvnym_226";
const styles$1 = {
  bar,
  expanding,
  nodeTag,
...
function AIExpandBar({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: barRef, className: `${styles$1.bar} ${isExpanding ? styles$1.expanding : ""}`, style: { left: pos.x, top: pos.y }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$1.nodeTag, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$1.nodeTitle, children: node.title }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$1.modesRow, children: LENSES.map((lens) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        className: `${styles$1.modeButton} ${selectedLens === lens.id ? styles$1.modeButtonActive : ""}`,
        onClick: () => onLensChange(lens.id),
        type: "button",
        disabled: isExpanding,
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$1.modeLabel, children: lens.label })
      },
      lens.id
    )) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$1.inputRow, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
          ref: inputRef,
          type: "text",
          className: styles$1.customInput,
          placeholder: "Guide the AI (optional)...",
          onKeyDown: (e) => e.key === "Enter" && handleSubmit(),
          disabled: isExpanding
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: styles$1.expandButton, onClick: handleSubmit, disabled: isExpanding, children: isExpanding ? "..." : "Run" })
    ] }),
    isExpanding && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$1.loadingOverlay, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles$1.spinner }) })
  ] });
}
...
function App() {
  ...
  const [diagnosticEntries, setDiagnosticEntries] = reactExports.useState([]);
  ...
  const [viewKey, setViewKey] = reactExports.useState(0);
  ...
  const autosaveSeqRef = reactExports.useRef(0);
  const saveResetTimerRef = reactExports.useRef(null);
  ...
  const refreshDiagnostics = reactExports.useCallback(async () => {
  ...
  const upsertMemoryDocument = reactExports.useCallback((doc) => {
    setMemoryDocuments((prev) => {
      const next = [doc, ...prev.filter((entry2) => entry2.id !== doc.id)];
      next.sort((a, b) => b.updatedAt - a.updatedAt);
      return next;
    });
  }, []);
  const refreshHistory = reactExports.useCallback(async () => {
  ...
  const handleDeleteMemoryDocument = reactExports.useCallback(
    async (id) => {
      try {
        setHistoryError(null);
        ...
        setMemoryDocuments((prev) => prev.filter((entry2) => entry2.id !== id));
        if (currentMapId === id) {
      ...
      try {
        ...
        if (params.inputKind === "pdf") {
          ...
          sourceResult = await window.api.source.ingestText({
            ...
            title: params.inputKind === "prompt" ? params.prompt : void 0
          });
        }
  ...
  const handlePasteGenerate = reactExports.useCallback(() => {
    if (!pasteText.trim()) {
  ...
  const handlePdfGenerate = reactExports.useCallback(
    async (file) => {
      if (!file) {
  ...
  const handleCloseCanvas = reactExports.useCallback(() => {
  ...
  const getSiblingTitles = reactExports.useCallback(
    (nodeId) => {
      if (!root) return [];
      const findParent2 = (node, targetId) => {
        for (const child of node.children) {
          if (child.id === targetId) return node;
          const found = findParent2(child, targetId);
          if (found) return found;
        }
        return null;
      };
      const parent = root.id === nodeId ? null : findParent2(root, nodeId);
      if (!parent) return [];
  ...
  const selectedPathNodes = reactExports.useMemo(
    () => selectedPathOrder.map((id) => getNode(id)).filter(Boolean),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.container, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: styles.topBar, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles.brandEyebrow, children: "Flows Blueprint 2.0" }),
    ...
    activeTab === "history" && /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: styles.historySection, children: [
      ...
      isHistoryLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles.historyLoading, children: "Loading…" }) : memoryDocuments.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles.historyEmpty, children: "Create your first compression map and it will appear here." }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles.historyList, children: memoryDocuments.map((doc) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.historyCardMain, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles.historyCardTitle, children: doc.title }),
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.overlayWorkspace, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: styles.overlayRail, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.railSection, children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.railCard, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.railMetaRow, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles.metaPill, children: currentSource?.inputKind || "prompt" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: styles.metaPill, children: selectedLens.replace("_", " ") })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles.railTitle, children: currentSource?.title || root?.title || "Untitled source" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: styles.railBody, children: currentSource?.sourceText?.slice(0, 220) || currentSource?.prompt || "Use this map to compress a source, challenge a branch, and dispatch the path that matters." })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.railSection, children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles.pathList, children: selectedPathNodes.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles.emptyHint, children: "Toggle selection mode and click nodes to build a branch path." }) : selectedPathNodes.map((node, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.pathItem, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.pathIndex, children: [
                    "Step ",
                    index + 1
                  ] }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.railSection, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles.railHeading, children: "Artifacts" }),
              latestBrief ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles.railCard, children: [
    ...
    menuState && isCanvasOpen && /* @__PURE__ */ jsxRuntimeExports.jsx(
      NodeContextMenu,
      {
        node: menuState.node,
    ...
    aiExpandModalState && isCanvasOpen && /* @__PURE__ */ jsxRuntimeExports.jsx(
      AIExpandBar,
      {
    ...
    notesModalNode && /* @__PURE__ */ jsxRuntimeExports.jsx(
      NotesModal,
      {
        node: notesModalNode,
    ...
    deleteConfirmNode && /* @__PURE__ */ jsxRuntimeExports.jsx(
      DeleteConfirmDialog,
      {
...
function parseExpandedContent(markdown, parentLevel) {
